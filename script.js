...
document.querySelector('button').addEventListener('click', function() {
  window.open('https://www.apple.com/apple-vision-pro/', '_blank');
});
...
gsap.to("#page1>video", {
  scrollTrigger: {
    ...
    scroller: "#main",
    onToggle: () => {
      document.querySelector("#page1>video").pause();
      document.querySelector("#page1>video").currentTime = 0;
...
gsap.to("#page2>video", {
  scrollTrigger: {
    ...
    scroller: "#main",
    onToggle: () => {
      document.querySelector("#page2>video").pause();
